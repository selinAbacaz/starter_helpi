    ...
    <Navbar style={{ padding: "10px", alignItems: "center" }}>
        ...
        <Navbar.Collapse id="basic-navbar-nav" style={{justifyContent: "flex-end"}}>
            <ButtonGroup variant="text"  sx={{ "& .MuiButtonGroup-grouped": { borderColor: "black" } }}>
                ...
                {submitted && <SwitchPage setCurrentPage={setCurrentPage} currentPage={currentPage} newCurrentPage={3} type={"nav"} blurPage={blurPage} setBlurPage={setBlurPage} questionsSubmitted={questionsSubmitted}></SwitchPage>}
            </ButtonGroup>
